...
import com.sprint3.admission_test.infrastructure.adapter.in.web.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ExpirationDateIsBeforeToday.class)
    public ResponseEntity<String> handlerExpirationDateIsBeforeToday(ExpirationDateIsBeforeToday ex) {
